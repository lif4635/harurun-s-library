...
| [`C(number, chosen)`](../../../combinatorics/RationalBinomial.py#L17) | method | `c`を求める。 | `number`: 整数<br>`chosen`: 選ぶ個数 | Fraction `Fraction(math.comb(number, chosen)) if 0 <= chosen <= number e...` |
