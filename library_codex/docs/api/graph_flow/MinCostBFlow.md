...
| [`add_supply(vertex, amount)`](../../../graph_flow/MinCostBFlow.py#L41) | method | supplyを追加する。 | `vertex`: 頂点番号<br>`amount`: 加算量・移動量 | `None` | — |
| [`add_demand(vertex, amount)`](../../../graph_flow/MinCostBFlow.py#L50) | method | demandを追加する。 | `vertex`: 頂点番号<br>`amount`: 加算量・移動量 | `None` | — |
