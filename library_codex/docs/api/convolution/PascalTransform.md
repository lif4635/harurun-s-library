...
# `library_codex.convolution.PascalTransform`

列へPascal変換または逆変換を適用する。

- 計算量の目安: 各操作の計算量はAPI表を参照
- source: [`convolution/PascalTransform.py`](../../../convolution/PascalTransform.py)
