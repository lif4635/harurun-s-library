...
# `library_codex.spatial_structure.CumulativeSum2D`

静的な二次元gridの任意の半開矩形和をO(1)で返す累積和。

- source: [`spatial_structure/CumulativeSum2D.py`](../../../spatial_structure/CumulativeSum2D.py)
...
- constructor: [`CumulativeSum2D(matrix)`](../../../spatial_structure/CumulativeSum2D.py#L6)
