...
| --- | --- | --- | --- | --- |
| [`find(vertex)`](../../../graph_connectivity/DynamicBipartiteGraph.py#L20) | method | 代表元・位置・対象要素を探す。 | `vertex`: 頂点番号（0-indexed） | 代表元・位置・node番号（int） |
| [`color(vertex)`](../../../graph_connectivity/DynamicBipartiteGraph.py#L35) | method | `color`を求める。 | `vertex`: 頂点番号（0-indexed） | `self.parity[vertex]` |
