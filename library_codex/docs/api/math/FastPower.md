...
# `library_codex.math.FastPower`

同じ底や指数で繰り返す累乗計算を前計算で高速化する。

- 計算量の目安: 各操作の計算量はAPI表を参照
- source: [`math/FastPower.py`](../../../math/FastPower.py)
...
- constructor: [`FastPower(base, mod, max_exponent=(1 << 63) - 1, block_bits=10)`](../../../math/FastPower.py#L8)
...
| --- | --- | --- | --- | --- |
| [`__call__(exponent)`](../../../math/FastPower.py#L27) | method | obj(...) として呼び出す。 | `exponent`: 非負の指数 | 計算結果（数値または入力要素型） |
