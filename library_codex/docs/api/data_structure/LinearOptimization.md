...
- `LineContainer2D`: 直線集合とrange linear add/range minを扱う `LineContainer2D`。
- `RangeLinearAddRangeMin`: 直線集合とrange linear add/range minを扱う `RangeLinearAddRangeMin`。
...
直線集合とrange linear add/range minを扱う `LineContainer2D`。
...
直線集合とrange linear add/range minを扱う `RangeLinearAddRangeMin`。
