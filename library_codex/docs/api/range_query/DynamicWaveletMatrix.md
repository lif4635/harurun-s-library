...
| --- | --- | --- | --- | --- |
| [`max_bit`](../../../range_query/DynamicWaveletMatrix.py#L1869) | property | 最大・`bit`を求める。 | なし | `int` / `self._levels` |
...
| method / property | 種別 | 用途 | 引数 | 返り値 |
| --- | --- | --- | --- | --- |
| [`coordinates`](../../../range_query/DynamicWaveletMatrix.py#L575) | property | `coordinates`を求める。 | なし | `tuple[int, ...]` / `self._coordinates` |
| [`candidate_count`](../../../range_query/DynamicWaveletMatrix.py#L580) | property | `candidate`・個数を求める。 | なし | `int` / `self._offsets[-1]` |
| [`packed_sums`](../../../range_query/DynamicWaveletMatrix.py#L585) | property | `packed`・`sums`を求める。 | なし | `bool` / `self._packed` |
