...
| --- | --- | --- | --- | --- |
| [`update(index, key, value)`](../../../segment_tree/SortableSegmentTree.py#L38) | method | index番目の値をvalueへ置き換える。 | `index`: 0-indexedの位置<br>`key`: 比較・格納に使うkey<br>`value`: 追加・設定・問い合わせる値 | `None` |
