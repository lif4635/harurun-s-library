...
| [graph](api/graph/README.md) | グラフアルゴリズム | 54 | 70 | 28 | 146 |
| [heuristic](api/heuristic/README.md) | ヒューリスティック探索 | 4 | 0 | 5 | 9 |
| [math](api/math/README.md) | 数学・線形代数・数論 | 42 | 85 | 25 | 123 |
...
| [tree](api/tree/README.md) | 木アルゴリズム・動的木 | 19 | 21 | 24 | 120 |

合計: **283 modules / 387 functions / 203 classes / 1207 methods・properties**。
